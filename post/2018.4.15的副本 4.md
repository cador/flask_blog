...
slug = "2018.4.15"
categories =  {"language":["R语言", "lattice" ]}
tags = {"theme2":["可视化" ]}
+++
...
```
![image](http://cador.cn/images/2018.4.14.13.svg)
...
barchart(yield ~ variety | site, data = barley,
         ...
         scales = list(x = list(abbreviate = TRUE,
                                minlength = 5)))
```
![image](http://cador.cn/images/2018.4.15.1.svg)
...
```
![image](http://cador.cn/images/2018.4.15.2.svg)
...
barchart(yield ~ variety | site, data = barley,
         ...
         layout = c(1,6))
```
![image](http://cador.cn/images/2018.4.15.3.svg)
...
barchart(yield ~ variety | site, data = barley,
         ...
         scales = list(x = list(rot = 45)))
```
![image](http://cador.cn/images/2018.4.15.4.svg)
...
```
![image](http://cador.cn/images/2018.4.15.5.svg)
3. 调整布局

```R
barchart(cut ~ price | color, data = diamonds.small,as.table = TRUE)
```
![image](http://cador.cn/images/2018.4.15.6.svg)
4. 使用两个条件变量

```R
barchart(cut ~ price | color + clarity, data = diamonds.small)
```
![image](http://cador.cn/images/2018.4.15.7.svg)
5. 自定义条形图
...
```
![image](http://cador.cn/images/2018.4.15.8.svg)
