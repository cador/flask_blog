...
&bull;&nbsp;[数据操作](#sjcz)
&emsp;&emsp;&deg;&nbsp;[变量筛选](#sjcz_blsx)
&emsp;&emsp;&deg;&nbsp;[记录过滤](#sjcz_jlgl)
&emsp;&emsp;&deg;&nbsp;[排序操作](#sjcz_bxcz)
&emsp;&emsp;&deg;&nbsp;[关联操作](#sjcz_glcz)
&emsp;&emsp;&deg;&nbsp;[衍生变量](#sjcz_ysbl)
&emsp;&emsp;&deg;&nbsp;[重命名变量](#sjcz_cmmbl)
&bull;&nbsp;[聚合分析](#jhfx)
&emsp;&emsp;&deg;&nbsp;[汇总函数](#jhfx_hzhs)
&emsp;&emsp;&deg;&nbsp;[分组函数](#jhfx_fzhs)
&emsp;&emsp;&deg;&nbsp;[聚合函数](#jhfx_jhhs)
&bull;&nbsp;[抽样函数](#cyhs)
&bull;&nbsp;[管道操作](#gdcz)
